        ...
        <div class="format-border">
            <div class="mainbg container-fluid" id="conteudo">
                ...
                <div class="text-primary">
                    <h4>RELATÓRIO DE ENTRADA E SAÍDA - LISTAGEM</h4>
                </div>
                <img src="img\DuckFundo2.png" alt="" class="bg-img">
                <form action='controller_relatorios' method='post'>
                    <table class="FormatTable">
                        <%
                            List<relatorios> kardlist = (List<relatorios>) request.getAttribute("RelEntradaSaida");

                        %><tr><th class="FormatTable">DATA MOVIMENTO</th><%
                            %><th class="FormatTable">DESCRICAO</th><%
                            %><th class="FormatTable">CODIGO PRODUTO</th><%
                            %><th class="FormatTable">DESCRICAO DO PRODUTO</th><%
                            %><th class="FormatTable">QUANTIDADE</th></tr><%                                for (relatorios it : kardlist) {
                        %><tr class="FormatTable"><%
                            %><td class="FormatTable"><%out.print(it.getDatamovimento());%></td><%
                            %><td class="FormatTable"><%out.print(it.getDescricaomov());%></td><%
