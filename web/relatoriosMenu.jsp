    ...
    <body>
        ...
        <div class="format-border">
            <div class="mainbg container-fluid" id="conteudo">
                ...
                <div class="format-report">                                    
                    <div> <a href="relEntradaSaida.jsp"> <img src="img/rel_ent_saida.png" alt="" /></a> </div>
                    <div> <a href="relbaixogiro.jsp"> <img src="img/rel_baixo_giro.png" alt=""/></a> </div>
                    <div> <a href="relvalorestoque.jsp"> <img src="img/rel_valor.png" alt=""/></a> </div>
                </div>
            </div>
        </div>
